...
CustomError::CustomError(std::string message, int errorCode, double arrears, size_t client_id) : message(std::move(message)), errorCode(errorCode), arrears(arrears), client_id(client_id) {}
