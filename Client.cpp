...
size_t Bank::MakeNewAccount(size_t choice, double count) {
  switch(choice) {
    case 0:
      list.push_back(std::make_shared<DebitAccount>(count));
      break;
    case 1:
      list.push_back(std::make_shared<CreditAccount>(count, limit, commission));
      break;
    case 2:
...
void Bank::AddAccount(size_t client_id, size_t choice_acc, double count = 0) {
  switch (choice_acc) {
    case 0:
      clients[client_id]->AddDebitAccount(MakeNewAccount(choice_acc, count));
      break;
    case 1:
      clients[client_id]->AddCreditAccount(MakeNewAccount(choice_acc, count));
      break;
    case 2:
